...
public class EncryptKeyPair {
    ...
    /***
     * Initializes a new EncryptKeyPair object
     ...
     * @return A NativeHandle that points to the public encryption key
     */
     ...
     * @return A NativeHandle that points to the secret encryption key
     */
