...
public class Session {
    ...
    /**
     * Encodes an Auth request for the Authenticator
    ...
    /**
     * Encode a shared mutable data request
     * @param req Shared mutable data request
     * @return Encoded shared mutable data request as {@link Request}
     */
    ...
    /**
     * Encode a request for an unregistered session
     * @param appId Application ID
     ...
     * @param uri The encoded response URI from the Authenticator
     ...
     * @return New {@link Session} object
     */
    ...
    /**
     * Establish a new registered session with the network for the given app
     * @param appId The Application instance
