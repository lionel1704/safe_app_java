...
/***
 * Exposes APIs for the cryptographic functions
 */
public class Crypto {
     ...
     * @return A sign key pair as {@link SignKeyPair}
     */
    ...
    /***
     * Create a new public sign key from a raw array
    ...
    /***
     * Create new secret signing key from a raw array
     * @param key Byte array
     ...
     * @return Encryption key pair as {@link EncryptKeyPair}
     */
    ...
    /**
     * Sign some data using a secret key
    ...
    /**
     * Encrypts data with the sender's public key and receiver's private key
     * @param recipientPublicEncryptKey Receiver's private key
     * @param senderSecretEncryptKey Sender's public key
    ...
    /**
     * Decrypts encrypted data using sender's public key and receiver's private key
     * @param senderPublicEncryptKey Sender's public key
     * @param recipientSecretEncryptKey Receiver's private key
    ...
    /**
     * Encrypts data using private and public keys with a seal
     * @param recipientPublicEncryptKey Recipient's public key
     * @param data Data to be encrypted
    ...
    /**
     * Retrieve secret encryption key as a raw array
    ...
    /**
     * Retrieve public sign key as a raw array
    ...
    /**
     * Retrieve secret sign key as a raw array
     * @param secretSignKey Secret sign key as {@link NativeHandle}
     * @return Raw secret sign key as a byte array
     */
    ...
    /**
     * Helper function to initialize secret sign key as {@link NativeHandle}
    ...
    /**
     * Helper function to initialize public encryption key as {@link NativeHandle}
    ...
    /**
     * Helper function to initialize secret encryption key as {@link NativeHandle}
