...
/**
 * Network File System emulation APIs on top of Mutable and Immutable data
 */
public class NFS {
    ...
    /**
     * Get the metadata of the requested file
    ...
    /**
     * Update the file present in the network
     * @param parentInfo Parent mutable data info
     * @param fileName File name
     * @param file The updated file to be stored
     * @param version The next version of the mutable data entry
     ...
     * @param fileContextHandle File handle as {@link NativeHandle}
     * @param position Position from which you want to read
     * @param length Length of the data that is to be read
    ...
    /**
     * Close the file that is open for read/write operations and write the content to the network.
     * The file handle is freed.
     * @param fileContextHandle File handle as {@link NativeHandle}
     * @return File object
     */
    ...
    /**
     * The various modes of opening a file in NFS
     */
